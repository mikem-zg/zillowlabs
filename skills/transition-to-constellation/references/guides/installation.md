...
Constellation v10.14.0 tarballs are bundled with this skill at `.agents/skills/constellation/packages/`. Copy them to your project root and add them to `package.json`:
...
|------|---------|-------------|
| `constellation-10.14.0.tgz` | `@zillow/constellation` | Core UI components (99 components) |
| `constellation-icons-10.14.0.tgz` | `@zillow/constellation-icons` | Icon library (621 icons) |
| `constellation-tokens-10.14.0.tgz` | `@zillow/constellation-tokens` | Design tokens (colors, spacing, etc.) |
| `constellation-fonts-10.14.0.tgz` | `@zillow/constellation-fonts` | Zillow typography |
| `constellation-config-10.14.0.tgz` | `@zillow/constellation-config` | PandaCSS preset configuration |
| `constellation-mcp-10.14.0.tgz` | `@zillow/constellation-mcp` | MCP server (17 tools, 253 resources) |
