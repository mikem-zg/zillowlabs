...
For single-agent concepts (lead lifecycle funnel, ranking mechanics, peer comparison, competitive dynamics, analysis windows), see `.agents/skills/databricks-agent-debugger/BUSINESS_CONCEPTS.md`.
