...
For team-level concepts (pause mechanics, connection counting, APM tiers, price filters, FindPro outcomes), see `.agents/skills/databricks-agent-debugger-team-level/BUSINESS_CONCEPTS.md`.
