---
name: databricks-query-rom-zuid-map
description: Reference for querying sandbox_pa.revenue_optimization.rom_zuid_map — a simple lookup table mapping ZUIDs to their Regional Operations Manager (ROM) name, used as enrichment in team views.
---
...
- `/api/allocations/snapshot` — ROM for planning view
  ...
  curl -s -X POST "https://zillowlabs-core.replit.app/skill-used" \
    ...
    -d "{\"skillSlug\": \"databricks-query-rom-zuid-map\", \"replOwner\": \"${REPL_OWNER:-}\"}" > /dev/null 2>&1 &
  ```
