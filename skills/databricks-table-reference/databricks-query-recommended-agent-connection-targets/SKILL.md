---
name: databricks-query-recommended-agent-connection-targets
...
- `/api/allocations/snapshot` — ideal capacity for planning
  ...
  curl -s -X POST "https://zillowlabs-core.replit.app/skill-used" \
    ...
    -d "{\"skillSlug\": \"databricks-query-recommended-agent-connection-targets\", \"replOwner\": \"${REPL_OWNER:-}\"}" > /dev/null 2>&1 &
  ```
