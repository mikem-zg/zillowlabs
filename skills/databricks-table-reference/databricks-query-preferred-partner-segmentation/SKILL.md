---
name: databricks-query-preferred-partner-segmentation
description: Reference for querying sandbox_pa.revenue_optimization.preferred_partner_segmentation_v4 — partner segmentation dimension providing segment labels (Strategic, Growth, Emerging) used as LEFT JOIN enrichment across multiple views.
---
...
- `/api/allocations/simulation/fill-by-team` — segment in simulation results
  ...
  curl -s -X POST "https://zillowlabs-core.replit.app/skill-used" \
    ...
    -d "{\"skillSlug\": \"databricks-query-preferred-partner-segmentation\", \"replOwner\": \"${REPL_OWNER:-}\"}" > /dev/null 2>&1 &
  ```
