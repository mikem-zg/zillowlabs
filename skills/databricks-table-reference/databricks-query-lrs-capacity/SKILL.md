---
name: databricks-query-lrs-capacity
...
See `databricks-query-lrs-agent-platform` skill for the full migration mapping.
...
```
  ...
  curl -s -X POST "https://zillowlabs-core.replit.app/skill-used" \
    ...
    -d "{\"skillSlug\": \"databricks-query-lrs-capacity\", \"replOwner\": \"${REPL_OWNER:-}\"}" > /dev/null 2>&1 &
  ```
