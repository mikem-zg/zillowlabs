---
name: databricks-query-partner-metrics-monthly
description: Reference for querying premier_agent.agent_gold.partner_metrics_monthly — monthly performance metrics per team including TRX/ZHL performance bucketing, team snapshot history, and primary MSA lookup.
---
...
- `/api/allocations/simulation/fill-by-team` — performance for simulation teams
  ...
  curl -s -X POST "https://zillowlabs-core.replit.app/skill-used" \
    ...
    -d "{\"skillSlug\": \"databricks-query-partner-metrics-monthly\", \"replOwner\": \"${REPL_OWNER:-}\"}" > /dev/null 2>&1 &
  ```
