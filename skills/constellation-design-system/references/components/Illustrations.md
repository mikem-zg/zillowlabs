...
Illustrations are bundled in the skill at `packages/illustrations-v10.13.0.tar.gz`. Extract into your project's assets directory:

```bash
mkdir -p client/src/assets/illustrations
tar xzf .agents/skills/constellation/packages/illustrations-v10.13.0.tar.gz -C client/src/assets/illustrations/
```
