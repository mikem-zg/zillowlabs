...
1. Fetch `skill-registry.json` from this repo
2. Compare each skill's `contentHash` with your local copy
3. Download only the changed `skills/{skill_name}/` folders
